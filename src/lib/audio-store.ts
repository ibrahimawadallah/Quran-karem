...
export const useAudioStore = create<AudioState>((set, get) => {
  ...
  return {
    ...
    // Player visibility
    showPlayer: () => set({ isPlayerVisible: true }),
    hidePlayer: () => set({ isPlayerVisible: false, isPlaying: false, audioError: null, currentAyahInSurah: 1 }),
    ...
    closeReadingModal: () =>
      set({ showSurahModal: false, readingModalSurah: null, currentAyahInSurah: 1 }),
    readingModalSurah: null,
